import 'package:flowers_store/controllers/filter/courses_filter_controller.dart';
...
class CourseFilterSheet {
  static Widget _filter() {
    return GetBuilder<CoursesFilterController>(
        init: CoursesFilterController(),
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
